...
def test_request_from_page(requests_mock):
    url = "https://web.archive.org/web/20120916140934/http://www.nga.gov/collection/anZ1.htm"
    ...
    assert request_response["status_code"] == 200  # type: ignore
    assert request_response["html"] == response_context  # type: ignore
